...
ENV PYSPARK_DRIVER_PYTHON_OPTS="notebook --no-browser --allow-root --ip=0.0.0.0 --port=${JUPYTER_PORT} --notebook-dir=/opt/spark/notebooks"
# --ip=0.0.0.0 - listen all interfaces
# --port=${JUPYTER_PORT} - listen ip on port 8889
# --notebook-dir=/opt/spark/notebooks - start in notebooks directory
